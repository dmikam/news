<div id="footer" class="clearfix">
	...
	<div id="line_content" class="line clearfix">
		...
		<h3 id="phlogo">Un especial de</h3>
		...
		<ul class="what">
			...
			<li class="cat-item cat-item-508 current-cat"><a href="http://periodismohumano.com/seccion/enfoques" title="Ver todas las entradas de Enfoques">Enfoques</a>
		</li>
			...
			<li class="cat-item cat-item-511"><a href="http://periodismohumano.com/seccion/multimedia" title="Ver todas las entradas de Multimedia">Multimedia</a>
		</li>
		</ul>
		<ul class="who">
...
<script type="text/javascript" charset="utf-8">
	jQuery('#multimedia embed').attr('width','900');
	jQuery('#multimedia embed').attr('height','500');
</script>
